...
const adminRoutes = [
  ...
  {
    path: '/admin/raw-material/create',
    name: 'raw-material-create',
    component: RawMaterialCreate,
    meta: { requiresAuth: true, roles: ['admin'] },
  },
  {
    path: '/admin/raw-material/:id/edit',
  ...
  {
    path: '/admin/material-issues/view/:id',
    name: 'material-issue-view',
    component: MaterialIssueView,
    meta: { requiresAuth: true, roles: ['admin'] },
  },
  ...
  // ================= Product Receive =================
  {
    path: '/admin/product-receives',
    name: 'product-receive-list',
    component: ProductReceiveList,
    meta: { requiresAuth: true, roles: ['admin'] },
  },
  {
    path: '/admin/product-receives/create',
    name: 'product-receive-create',
    component: ProductReceiveCreate,
    meta: { requiresAuth: true, roles: ['admin'] },
  },
  {
    path: '/admin/product-receives/view/:id',
    name: 'product-receive-view',
    component: ProductReceiveView,
    meta: { requiresAuth: true, roles: ['admin'] },
  },

  // ================= Sales & Wastage =================
  {
    path: '/admin/product-returns',
    name: 'product-return-list',
    component: ProductReceiveReturnList,
    meta: { requiresAuth: true, roles: ['admin'] },
  },
  {
    path: '/admin/product-wastages',
    name: 'product-wastage-list',
    component: ProductWastageList,
    meta: { requiresAuth: true, roles: ['admin'] },
  },
  {
  ...
  {
    path: '/admin/product-sales/create',
